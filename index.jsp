...
<p>You can find how many vehicle is on road through my company to your city or closest to it</p>
                <div id="features">
                  ...
                  <ul>
                    <li><a href="#">Free Core java tutorial</a></li>
					<li><a href="#">Jsp tutorial</a></li>
                    <li><a href="#">Free Android Tutorial</a></li>
                    <li><a href="#">Struts and Hibernet Tutorial</a></li>
                  ...
                  <ul>
                    ...
                    <li><a href="#">Html,Sql Tutorial</a></li>
                  </ul>
                  <div class="clear"> </div>
                </div>
  ...
  <div id="copyright">
   Copyright 2012 ,All Rights Reserved,For more information plz visit <a href="#">Click Here </a>
  </div>
